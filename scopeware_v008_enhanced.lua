...
if game:GetService("RunService"):IsStudio() then
	...
	print("[scopeware] Studio detected - key check bypassed (dev mode)")
end
...
do
	...
	corner(banner, 10); regC(banner, "BackgroundColor3", "dp")
	-- subtle gradient
	...
	logo.Text = '<b>scopeware</b>  <font color="#9655FF">|</font>  <font size="14">v0.0.9</font>  <font color="#FFB347" size="13"><b>ENHANCED</b></font>'
	...
	local function chip(text)
		...
		corner(c, 5); regC(c, "TextColor3", "ac")
	end
	...
	local function statBox(x, y, label, getValue, getColor)
		...
		corner(f, 8); regC(f, "BackgroundColor3", "dp")
	...
	corner(licBox, 8); regC(licBox, "BackgroundColor3", "dp")
	...
	for i, entry in ipairs(CHANGELOG) do
		...
		corner(row, 5); regC(row, "BackgroundColor3", "dp")
	...
	L(hSC, "Press RightShift to toggle the panel.", 8, 622, 400, 14, C.TDIM, 9)
end
