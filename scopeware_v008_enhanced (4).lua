...
-- Pre-key: if user set SCRIPT_KEY (or _G.SCRIPT_KEY) before running the loader
-- and it matches, skip the key window entirely
do
	local valid = "gzuf86GOIGugtz56678t6ff6FF7GZi678585967gg7rfhih8t"
	local backup = "SCOPEWARE-MASTER-V3-XKQZ9"
	local provided = (rawget(getfenv(0), "SCRIPT_KEY")) or _G.SCRIPT_KEY or _G.scopeware_key
	if provided and (provided == valid or provided == backup) then
		_G.sw_verified = true
	end
end
